void WeightediPhoTreeMaker()
{   
   

 // TFile *f = TFile::Open("/afs/cern.ch/user/j/jhossain/eos/Hgg_AC_analysis/Prod_Ntuples_2024/Prod_Pre_2016/output_ggjets_2016PreVFP.root");
 //  TFile *f = TFile::Open("/afs/cern.ch/user/j/jhossain/eos/Hgg_AC_analysis/Prod_Ntuples_2024/Prod_Post_2016/output_ggjets_2016PostVFP.root");
 //  TFile *f = TFile::Open("/afs/cern.ch/user/j/jhossain/eos/Hgg_AC_analysis/Prod_Ntuples_2024/Prod_2017/output_ggjets_2017.root");
   TFile *f = TFile::Open("/afs/cern.ch/user/j/jhossain/eos/Hgg_AC_analysis/Prod_Ntuples_2024/Prod_2018/output_ggjets_2018.root");

  //TFile *fileout = new TFile("output_ggjets_reweighted_2016PreVFP.root","recreate");
  // TFile *fileout = new TFile("output_ggjets_reweighted_2016PostVFP.root","recreate");
  // TFile *fileout = new TFile("output_ggjets_reweighted_2017.root","recreate");
  TFile *fileout = new TFile("output_ggjets_reweighted_2018.root","recreate");
