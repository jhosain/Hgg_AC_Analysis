...
void qcdfraction_EE_sub()
{

    TFile* final_file = TFile::Open("subleading_EE_PF_qcdfraction.root", "RECREATE");
    ...
    TH1F *hgg_pf = (TH1F*)fgg->Get("h_pf_EE_subleading");
    TH1F *hgg_fp = (TH1F*)fgg->Get("h_fp_EE_subleading");
    TH1F *hgj_pf = (TH1F*)fgj->Get("h_pf_EE_subleading");
    TH1F *hgj_fp = (TH1F*)fgj->Get("h_fp_EE_subleading");
    TH1F *hjj_pf = (TH1F*)fjj->Get("h_pf_EE_subleading");
    TH1F *hjj_fp = (TH1F*)fjj->Get("h_fp_EE_subleading");
...
*/
   ...
   c1->Print("Plots/subleading_EE_PF_qcdfraction_2016PostVFP.png");
   c1->Print("Plots/subleading_EE_PF_qcdfraction_2016PostVFP.pdf");

   final_file->Write();
   final_file->cd();
   num->SetName("subleading_EE_PF_qcdfraction");
   num->Write();
   final_file->Close();
