...
{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dipho_leadPt,1); else continue;}
                
else if (File_Names[i]=="output_data_driven_bkg_2017.root") {hist_[i]->Fill(dipho_leadPt, wt);}

else if (File_Names[i]=="output_ggjets_2017.root") { hist_[i]->Fill(dipho_leadPt, wt*lumi);}

else {if (!(dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_lead_genmatch==1 || dipho_sublead_genmatch==1) && (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) {hist_[i]->Fill(dipho_leadPt, wt*lumi);}}
...
//  c2->SetTopMargin(0);
  ...
  rp1->GetXaxis()->SetTitle("dipho_leadPt");
