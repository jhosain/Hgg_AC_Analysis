...
void Eff_qcdfraction_EB_sub()
{


//    TFile* final_file = TFile::Open("Eff_subleading_EB_PF_qcdfraction.root", "RECREATE");
...
*/
   ...
   c1->Print("Plots/Eff_subleading_EB_PF_qcdfraction_2016PostVFP.png");
   c1->Print("Plots/Eff_subleading_EB_PF_qcdfraction_2016PostVFP.pdf");
/*
   final_file->Write();
   final_file->cd();
   num->SetName("Eff_subleading_EB_PF_qcdfraction");
   num->Write();
   final_file->Close();
*/   
}
