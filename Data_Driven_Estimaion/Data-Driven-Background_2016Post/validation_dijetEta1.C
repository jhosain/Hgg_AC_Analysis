...
{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dijet_leadEta,1);}
                
else if (File_Names[i]=="output_data_driven_bkg_2016PostVFP.root") {hist_[i]->Fill(dijet_leadEta, wt);}

else if (File_Names[i]=="output_ggjets_2016PostVFP.root") 
{if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dijet_leadEta, wt*lumi);}

//else {if (!(dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_lead_genmatch==1 || dipho_sublead_genmatch==1) && (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) {hist_[i]->Fill(dijet_leadEta, wt*lumi);}}
...
hist_[i]->Fill(dijet_leadEta, wt*lumi);}

else hist_[i]->Fill(dijet_leadEta, wt*lumi);
...
//  c2->SetTopMargin(0);
  ...
  rp1->GetXaxis()->SetTitle("dijet_leadEta");
...
//  l1->Draw("same");
  ...
  c->Print("Plots/validation_dijet_leadEta.png");
  c->Print("Plots/validation_dijet_leadEta.pdf"); 
