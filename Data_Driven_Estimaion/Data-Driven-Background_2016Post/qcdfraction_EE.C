...
void qcdfraction_EE()
{
    ...
    TFile* final_file = TFile::Open("leading_EE_FP_qcdfraction.root", "RECREATE");
...
*/
   ...
   c1->Print("Plots/leading_EE_FP_qcdfraction_2016PostVFP.png");
   c1->Print("Plots/leading_EE_FP_qcdfraction_2016PostVFP.pdf");

   final_file->Write();
   final_file->cd();
   num->SetName("leading_EE_FP_qcdfraction");
   num->Write();
   final_file->Close();
