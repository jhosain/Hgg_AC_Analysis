...
void Eff_qcdfraction_EE()
{


//    TFile* final_file = TFile::Open("Eff_leading_EE_FP_qcdfraction.root", "RECREATE");
    ...
    TH1F *hgg_pf = (TH1F*)fgg->Get("h_pf_EE_leading");
    TH1F *hgg_fp = (TH1F*)fgg->Get("h_fp_EE_leading");
...
*/
   ...
   c1->Print("Plots/Eff_leading_EE_FP_qcdfraction_2016PostVFP.png");
   c1->Print("Plots/Eff_leading_EE_FP_qcdfraction_2016PostVFP.pdf");

/*   final_file->Write();
   final_file->cd();
   num->SetName("Eff_leading_EE_FP_qcdfraction");
   num->Write();
   final_file->Close();
  */ 
}
