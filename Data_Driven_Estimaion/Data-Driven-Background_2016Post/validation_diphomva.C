...
//      tree->SetBranchAddress("dijet_dphi", &dijet_dphi);
    ...
    hist_[i] = new TH1F("hist", "", 50, -1.0, 1.0 );
...
{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dipho_mva,1);}
                
else if (File_Names[i]=="output_data_driven_bkg_2016PostVFP.root") {hist_[i]->Fill(dipho_mva, wt);}

else if (File_Names[i]=="output_ggjets_2016PostVFP.root") 
{if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)  hist_[i]->Fill(dipho_mva, wt*lumi);}

//else {if (!(dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_lead_genmatch==1 || dipho_sublead_genmatch==1) && (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) {hist_[i]->Fill(dipho_mva, wt*lumi);}}
...
hist_[i]->Fill(dipho_mva, wt*lumi);}

else hist_[i]->Fill(dipho_mva, wt*lumi);
...
//  c2->SetTopMargin(0);
  ...
  rp1->GetXaxis()->SetTitle("dipho_mva");
...
//  l1->Draw("same");
 ...
 c->Print("Plots/validation_dipho_mva.png");
 c->Print("Plots/validation_dipho_mva.pdf"); 
