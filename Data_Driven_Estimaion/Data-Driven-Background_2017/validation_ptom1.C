...
void validation_ptom1(){
 ...
 std::vector<std::string> File_Names = {
  ...
  for (int i=0; i< File_Names.size(); i++){
   ...
   else if (File_Names[i] =="output_gjet_2017.root") Tname = "tagsDumper/trees/gjets_13TeV_VBFTag_2";
...
if (File_Names[i]=="output_Data_2017.root")

{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dipho_lead_ptoM,1); else continue;}
                
else if (File_Names[i]=="output_data_driven_bkg_2017.root") {hist_[i]->Fill(dipho_lead_ptoM, wt);}

else if (File_Names[i]=="output_ggjets_2017.root") 
...
/*
else if (File_Names[i]=="output_jj_2017.root")
...
//  c1->SetLogy();
  ...
  TLatex *tl = new TLatex(0.53,0.9," #bf{CMS} #it{Preliminary}                          41.5 fb^{-1} (13 TeV) 2017");
  tl->SetNDC();
  tl->SetTextFont(42);
  tl->SetTextSize(0.04);
  tl->SetTextAlign(20);
