...
//### Prompt-Fake Filter
    ...
    if((dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_lead_genmatch==1 || dipho_sublead_genmatch==1)) continue;

{
//### Photon Standard Trigger selection
...
//### VBF loose preselction to increase	the statistics      
     if( CMS_hgg_mass > 100 && CMS_hgg_mass < 180 && dipho_lead_ptoM > 0.25 && dipho_sublead_ptoM > 0.2 && fabs(dipho_leadEta) < 2.5 && fabs(dipho_subleadEta) < 2.5 && dijet_leadPt > 30.0 && dijet_subleadPt > 20.0 )
