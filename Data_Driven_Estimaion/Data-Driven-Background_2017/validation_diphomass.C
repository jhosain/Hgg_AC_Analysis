...
else if (File_Names[i]=="output_data_driven_bkg_2017.root") {hist_[i]->Fill(dipho_mass, wt);}

else if (File_Names[i]=="output_ggjets_2017.root") { if ((dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) hist_[i]->Fill(dipho_mass, wt*lumi);}
...
//else {if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) continue;
...
std::cout << "count" << " : " << count << std::endl; 
  ...
  c->Divide(1, 3); // Divide the canvas into 1 column and 3 rows
...
//  c->Update();
  c->Print("Plots/validation_dipho_mass.png");
  c->Print("Plots/validation_dipho_mass.pdf"); 
