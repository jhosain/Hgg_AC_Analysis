...
void validation_diphomass(){

 std::vector<std::string> File_Names = {
		"output_Data_2018.root",
                "output_data_driven_bkg_2018.root",
                "output_ggjets_2018.root",
		"output_gjet_2018.root",
  		"output_jj_2018.root"
  };
  ...
  for (int i=0; i< File_Names.size(); i++){
   ...
   if(File_Names[i]== "output_Data_2018.root") Tname = "tagsDumper/trees/Data_13TeV_VBFTag_2";
   else if (File_Names[i] =="output_ggjets_2018.root") Tname = "tagsDumper/trees/dipho_13TeV_VBFTag_2";
   else if (File_Names[i] =="output_gjet_2018.root") Tname = "tagsDumper/trees/gjets_13TeV_VBFTag_2";
   else if (File_Names[i] =="output_jj_2018.root") Tname = "tagsDumper/trees/qcd_13TeV_VBFTag_2";
...
//      tree->SetBranchAddress("dijet_dphi", &dijet_dphi);
    ...
    hist_[i] = new TH1F("hist", "", 80, 100.0, 180.0 );
       ...
       bool isBlindedRegion = (CMS_hgg_mass > 115 && CMS_hgg_mass < 135);
{
  ...
  if (!isBlindedRegion && CMS_hgg_mass > 100 && CMS_hgg_mass < 180  && dipho_lead_ptoM > 0.25 && dipho_sublead_ptoM > 0.2 && dijet_leadPt > 30.0 && dijet_subleadPt > 20.0 && fabs(dijet_leadEta) < 4.7 && fabs(dijet_subleadEta) < 4.7 && fabs(dipho_leadEta) < 2.5 && fabs(dipho_subleadEta) < 2.5)
// if (!isBlindedRegion && CMS_hgg_mass > 100 && CMS_hgg_mass < 180  && dipho_lead_ptoM > 0.33 && dipho_sublead_ptoM > 0.25 && dijet_leadPt > 30.0 && dijet_subleadPt > 30.0 && fabs(dijet_leadEta) < 4.7 && fabs(dijet_subleadEta) < 4.7 && fabs(dipho_leadEta) < 2.5 && fabs(dipho_subleadEta) < 2.5)if (!isBlindedRegion && CMS_hgg_mass > 100 && CMS_hgg_mass < 180  && dipho_lead_ptoM > 0.33 && dipho_sublead_ptoM > 0.25 && dijet_leadPt > 30.0 && dijet_subleadPt > 30.0 && fabs(dijet_leadEta) < 4.7 && fabs(dijet_subleadEta) < 4.7 && fabs(dipho_leadEta) < 2.5 && fabs(dipho_subleadEta) < 2.5)

  {

if (File_Names[i]=="output_Data_2018.root")

{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dipho_mass,1);}
                
else if (File_Names[i]=="output_data_driven_bkg_2018.root") {hist_[i]->Fill(dipho_mass, wt);}

else if (File_Names[i]=="output_ggjets_2018.root") { if ((dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) hist_[i]->Fill(dipho_mass, wt*lumi);}

/*
else if (File_Names[i]=="output_jj_2018.root")

{if (!(dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_leadIDMVA < -0.2 && dipho_subleadIDMVA < -0.2))
hist_[i]->Fill(dipho_mass, wt*lumi);}

else hist_[i]->Fill(dipho_mass, wt*lumi);
*/

else {if (!(dipho_lead_genmatch==1 && dipho_sublead_genmatch==1) && (dipho_lead_genmatch==1 || dipho_sublead_genmatch==1) && (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2)) {hist_[i]->Fill(dipho_mass, wt*lumi);}}
...
//  c1->SetLogy();
  ...
  TLatex *tl = new TLatex(0.53,0.9," #bf{CMS} #it{Preliminary}                          59.8 fb^{-1} (13 TeV) 2018");
  tl->SetNDC();
  tl->SetTextFont(42);
  tl->SetTextSize(0.04);
  tl->SetTextAlign(20);
...
//  c3->SetPad(c2->GetX1(), 0, c2->GetX2(), c2->GetY1());
  ...
  rp1->GetXaxis()->SetTitle("m_{#gamma#gamma}");
...
//  c->cd();
  ...
  c->Print("Plots/validation_dipho_mass_2018.png");
  c->Print("Plots/validation_dipho_mass_2018.pdf"); 
