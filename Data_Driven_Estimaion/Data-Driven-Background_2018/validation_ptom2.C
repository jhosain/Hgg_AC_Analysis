...
else if (File_Names[i]=="output_data_driven_bkg_2018.root") {hist_[i]->Fill(dipho_sublead_ptoM, wt);}
...
//  c1->SetLogy();
  ...
  TLatex *tl = new TLatex(0.53,0.9," #bf{CMS} #it{Preliminary}                          59.8 fb^{-1} (13 TeV) ");
  tl->SetNDC();
  tl->SetTextFont(42);
  tl->SetTextSize(0.04);
  tl->SetTextAlign(20);
