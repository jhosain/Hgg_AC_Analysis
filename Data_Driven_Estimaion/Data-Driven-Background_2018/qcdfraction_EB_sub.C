...
//   float ymax = num->GetMaximum();
   ...
   TLatex *t2a = new TLatex(0.54,0.91," #bf{CMS} #it{Simulation}                                            (13 TeV) 2018");
   t2a->SetNDC();
   t2a->SetTextFont(42);
...
*/
   ...
   c1->Print("Plots/subleading_EB_PF_qcdfraction_2018.png");
   c1->Print("Plots/subleading_EB_PF_qcdfraction_2018.pdf");
