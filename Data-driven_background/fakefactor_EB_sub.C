...
void fakefactor_EB_sub()
{
   ...
   TFile* final_file = TFile::Open("EB_subleading_fakefactor.root", "RECREATE");
    ...
    TH1F *hdt1 = (TH1F*)fdt->Get("h_pp_EB_subleading");
    TH1F *hgg1 = (TH1F*)fgg->Get("h_pp_EB_subleading");
    
    TH1F *hdt2 = (TH1F*)fdt->Get("h_pf_EB_subleading");
    TH1F *hgg2 = (TH1F*)fgg->Get("h_pf_EB_subleading");
   ...
   hdt1->SetName("EB_subleading_fakefactor");
