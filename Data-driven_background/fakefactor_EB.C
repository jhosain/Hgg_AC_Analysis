...
void fakefactor_EB()
{
   ...
   TFile* final_file = TFile::Open("EB_leading_fakefactor.root", "RECREATE");
    ...
    TH1F *hdt1 = (TH1F*)fdt->Get("h_pp_EB_leading");
    TH1F *hgg1 = (TH1F*)fgg->Get("h_pp_EB_leading");
    
    TH1F *hdt2 = (TH1F*)fdt->Get("h_pf_EB_leading");
    TH1F *hgg2 = (TH1F*)fgg->Get("h_pf_EB_leading");
   ...
   hdt1->SetName("EB_leading_fakefactor");
