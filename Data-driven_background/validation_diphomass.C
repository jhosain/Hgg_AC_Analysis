...
{ if (dipho_leadIDMVA > -0.2 && dipho_subleadIDMVA > -0.2) hist_[i]->Fill(dipho_mass,1); else continue;}
                
else if (File_Names[i]=="output_data_driven_bkg_2017.root") {hist_[i]->Fill(dipho_mass, wt);}

else if (File_Names[i]=="output_ggjets_2017.root") { hist_[i]->Fill(dipho_mass, wt*lumi);}
