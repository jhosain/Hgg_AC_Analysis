...
{  
     ...
     if( dipho_leadIDMVA > -0.2  &&  dipho_subleadIDMVA < -0.25) { if(fabs(dipho_leadEta) < 1.4442 )  h_pf_EB_leading->Fill(dipho_leadPt, weight * lumi);
     ...
     if( dipho_leadIDMVA < -0.25 &&  dipho_subleadIDMVA > -0.2) { if(fabs(dipho_leadEta) < 1.4442 )  h_fp_EB_leading->Fill(dipho_leadPt, weight * lumi);
     ...
     if( dipho_leadIDMVA < -0.25  &&  dipho_subleadIDMVA < -0.25) { if(fabs(dipho_leadEta) < 1.4442 )  h_ff_EB_leading->Fill(dipho_leadPt, weight * lumi);
