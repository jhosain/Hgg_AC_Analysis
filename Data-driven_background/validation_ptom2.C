...
//      tree->SetBranchAddress("dijet_dphi", &dijet_dphi);
    ...
    hist_[i] = new TH1F("hist", "", 50, 0.2, 0.7 );
       ...
       bool isBlindedRegion = (CMS_hgg_mass > 115 && CMS_hgg_mass < 135);
{
  ...
  if (!isBlindedRegion && CMS_hgg_mass > 100 && CMS_hgg_mass < 180 && dipho_lead_ptoM > 0.33 && dipho_leadPt > 35.0 && dipho_sublead_ptoM > 0.25 && dijet_leadPt > 40.0 && dijet_subleadPt > 30.0 && fabs(dijet_leadEta) < 4.7 && fabs(dijet_subleadEta) < 4.7 && fabs(dipho_leadEta) < 2.5 && fabs(dipho_subleadEta) < 2.5 && dipho_leadIDMVA > -0.9 && dipho_subleadIDMVA > -0.9)
...
else if (File_Names[i]=="output_ggjets_2017.root") { hist_[i]->Fill(dipho_sublead_ptoM, wt*lumi);}
