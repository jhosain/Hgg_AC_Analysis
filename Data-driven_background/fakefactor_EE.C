...
void fakefactor_EE()
{
   ...
   TFile* final_file = TFile::Open("EE_leading_fakefactor.root", "RECREATE");
    ...
    TH1F *hdt1 = (TH1F*)fdt->Get("h_pp_EE_leading");
    TH1F *hgg1 = (TH1F*)fgg->Get("h_pp_EE_leading");
    
    TH1F *hdt2 = (TH1F*)fdt->Get("h_pf_EE_leading");
    TH1F *hgg2 = (TH1F*)fgg->Get("h_pf_EE_leading");
   ...
   hdt1->SetName("EE_leading_fakefactor");
